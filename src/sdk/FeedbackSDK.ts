...
class FeedbackSDK {
  ...
  private addEventListeners() {
    ...
    triggerBtn?.addEventListener('click', () => this.openWidget());
  ...
  private async loadFeedbackContent() {
    const content = document.getElementById('feedback-content');
    if (!content) return;
    
    try {
      // Load feedback content directly instead of using iframe
  ...
  public updateConfig(newConfig: Partial<FeedbackConfig>) {
